...
class BubbleLayer : CALayer {
    ...
    convenience init(string: String) {
        ...
        backgroundColor = UIColor(displayP3Red: 0.59, green: 0.95, blue: 0.45, alpha: 1.0).cgColor
        borderColor = UIColor.white.cgColor
        borderWidth = 3.5
        
//        switch layerLabel {
//           case "Trash": layerLabel.backgroundColor = UIColor(displayP3Red: 0.59, green: 0.95, blue: 0.45, alpha: 1.0).cgColor
//          // case "Recyclable": label.backgroundColor = UIColor.purple
//           default:        layerLabel.backgroundColor = UIColor(displayP3Red: 0.59, green: 0.95, blue: 0.45, alpha: 1.0).cgColor
//        }
